...
//feedback
const feedbackInput = document.getElementById("customerFeedback");
const charCount = document.getElementById("charCount");
const sendFeedback = document.getElementById("sendFeedback");
const feedbackMessage = document.getElementById("feedbackMessage");

feedbackInput.addEventListener("input", function () {
    const remaining = 300 - feedbackInput.value.length;
...
sendFeedback.addEventListener("click", function () {
    if (feedbackInput.value.trim() !== "") {
        ...
        feedbackInput.value = "";
        charCount.textContent = "300 characters remaining"; // Reset counter
    }
});